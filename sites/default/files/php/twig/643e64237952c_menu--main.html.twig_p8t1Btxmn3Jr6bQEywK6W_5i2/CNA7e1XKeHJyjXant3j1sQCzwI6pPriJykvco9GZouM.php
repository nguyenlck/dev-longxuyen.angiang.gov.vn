...
/* themes/gavias_batiz/templates/navigation/menu--main.html.twig */
class __TwigTemplate_3c0826c10ad12c808841919485100638 extends Template
{
    private $source;
    private $macros = [];
...
($context["class_columns"] ?? null)];
        ...
        <a href=\"";
          ...
          ";
                    ...
                    if ((twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 65) || ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 65), "gva_layout", [], "any", false, false, true, 65) == "menu-block") && (($context["menu_level"] ?? null) == 0)))) {
                        // line 66
                        echo "            <span class=\"icaret nav-plus nav-plus fa fa-angle-down\"></span>
          ";
                    }
                    // line 67
                    echo "  
  ...
  ";
    ...
    {
        return "themes/gavias_batiz/templates/navigation/menu--main.html.twig";
    }
    ...
    {
        return new Source("", "themes/gavias_batiz/templates/navigation/menu--main.html.twig", "C:\\wamp64\\www\\dev-longxuyen.angiang.gov.vn\\themes\\gavias_batiz\\templates\\navigation\\menu--main.html.twig");
    }
