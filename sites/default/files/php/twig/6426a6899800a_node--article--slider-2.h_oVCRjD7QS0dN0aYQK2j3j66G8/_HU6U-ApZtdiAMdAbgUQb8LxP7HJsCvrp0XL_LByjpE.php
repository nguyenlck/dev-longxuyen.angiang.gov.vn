...
/* themes/gavias_batiz/templates/node/node--article--slider-2.html.twig */
class __TwigTemplate_c0ee0da32f8ac5e9d89f041b2cc864be extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 8, $this->source)))) : ("")), 6 => "post-block"];
        // line 12
        echo "
<div";
        // line 13
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null)], "method", false, false, true, 13), "addClass", [0 => "slider-2"], "method", false, false, true, 13), 13, $this->source), "html", null, true);
        echo ">
...
";
    ...
    {
        return "themes/gavias_batiz/templates/node/node--article--slider-2.html.twig";
    }
    ...
    {
        return array (  92 => 26,  88 => 25,  80 => 24,  74 => 23,  68 => 19,  63 => 18,  59 => 17,  54 => 15,  49 => 13,  46 => 12,  44 => 8,  43 => 7,  42 => 6,  41 => 5,  40 => 4,  39 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/gavias_batiz/templates/node/node--article--slider-2.html.twig", "C:\\wamp64\\www\\dev-longxuyen.angiang.gov.vn\\themes\\gavias_batiz\\templates\\node\\node--article--slider-2.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 2, "if" => 17);
        static $filters = array("clean_class" => 4, "escape" => 13, "t" => 26);
