...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
       ...
       ?>
         <script src="https://maps.googleapis.com/maps/api/js?key&libraries=places%2Cweather%2Cpanoramio&language=en&ver=4.9.3"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_batiz')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_batiz')) ?>/vendor/jquery.ui.map.min.js"></script>

         <div class="gsc-map <?php print $el_class ?>" <?php print gavias_content_builder_print_animate_aos($animate, $animate_delay) ?>>
